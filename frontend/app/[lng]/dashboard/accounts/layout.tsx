...
/**
 * Generates metadata for the accounts dashboard page.
 */
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  return {
    title: t('pages.accounts.meta.title'),
    description: t('pages.accounts.meta.description'),
  };
}

/**
 * Layout component for the accounts dashboard.
