...
/**
 * Generates metadata for the "Create New Account" page.
 */
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  return {
    title: t('pages.accounts.new.meta.title'),
    description: t('pages.accounts.new.meta.description'),
  };
}

/**
 * Layout component for the "Create New Account" page.
 */
