...
/**
 * Generates metadata for the "Account Details" page.
 */
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  return {
    title: t('pages.accounts.account.meta.title'),
    description: t('pages.accounts.account.meta.description'),
  };
}

/**
 * Layout component for the "Account Details" page.
 */
